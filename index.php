...
<body class="bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center min-h-screen">
    <div class="bg-white rounded-xl shadow-lg flex flex-col md:flex-row w-full max-w-xl transform transition-all hover:scale-105 hover:shadow-2xl overflow-hidden">
        <!-- Para añadir imagen al lado del formulario
        <div class="md:w-1/2 hidden md:block">
            <img src="https://pics.craiyon.com/2023-08-06/266028573bcc4e25b8d51c13cbd8c4ea.webp" 
        ...
        <div class="w-full p-8">
            <div class="text-center">
                <h2 class="text-3xl font-extrabold text-gray-800 mb-4">¡Bienvenido a <span class="text-indigo-500">SoundVibes!</span></h2>
        ...
        <div class="mt-6 text-center">
            <p class="text-sm text-gray-600">No tienes cuena? 
